...
class func{
	...
	Function:	IsCode
	Output:		True / False
	Input:		Строка кода доступа, Маска, Длина ("10, 25") && ("10") 
	Descriiption: Проверяет правильность ввода кода доступа
	\*======================================================================*/
	...
	Output:		True / False
	Input:		Email 
	Descriiption: Проверяет правильность ввода кошелька PAYEER
	\*======================================================================*/
